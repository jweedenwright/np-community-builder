...
-- INSERT INTO dbo.volunteer (id,first_name,middle_name,last_name,suffix,email,phone,dob,skills,interests,availability,find_out_about_us,include_email_dist,active) VALUES(2,'Ian','','Wilson','','iwilson0722@gmail.com','615-111-1111','20000101','','','','',1,1);
...
--INSERT INTO dbo.address (volunteer_id, street_one,street_two,city,state,zip) VALUES(2,'103 N 1st','','Nashville','TN','37215');
...
--INSERT INTO dbo.emergency_contact (volunteer_id, first_name,last_name,phone) VALUES(2);
...
--INSERT INTO dbo.app_user (username, password, date_added, user_type_id, volunteer_id, active) VALUES ('recruitment@bgcrc.net','tester','2020-02-20',1,2,1);
