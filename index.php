...
<div class="container">
	<div class="row">
		...
		<div class="volunteer-btns col-xs-12 text-center">
			<a href="<?=$root_dir?>/pages/sign-in.php" class="btn-lg btn-success">Sign in</a>
			<a href="<?=$root_dir?>/pages/sign-out.php" class="btn-lg btn-warning">Sign out</a>
		</div>
